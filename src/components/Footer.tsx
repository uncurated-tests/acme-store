  ...
  return (
    <footer className="border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        {/* Newsletter */}
        <div className="mb-12 rounded-2xl bg-zinc-100 p-8 dark:bg-zinc-800">
          <div className="mx-auto max-w-2xl text-center">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="mt-4 flex gap-2 sm:mx-auto sm:max-w-md">
                <Input
                  type="email"
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          {/* Support Links */}
          <div>
            <h4 className="font-semibold text-zinc-900 dark:text-white">Support</h4>
            <ul className="mt-4 space-y-2">
        ...
        {/* Bottom */}
        <div className="mt-12 flex flex-col items-center justify-between border-t border-zinc-200 pt-8 dark:border-zinc-800 sm:flex-row">
